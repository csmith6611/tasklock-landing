        ...
        <div className="container nav__container">
          <a href="#" className="nav__logo">
            <svg className="nav__icon" viewBox="0 0 100 100" fill="none">
              <rect x="20" y="45" width="60" height="45" rx="8" fill="currentColor"/>
              <path d="M30 45 L30 30 Q30 10 50 10 Q70 10 70 30 L70 45" fill="none" stroke="currentColor" strokeWidth="8" strokeLinecap="round"/>
            </svg>
            <span>TaskLock</span>
          </a>
          <div className="nav__links">
            ...
            <a href="#signup" className="btn btn--primary btn--small">Early Access</a>
          </div>
        </div>
      </nav>
        ...
        <div className="container">
          <div className="hero__content">
            ...
            <h1 className="hero__title animate-in delay-1">
              Get Things Done by Changing the Environment — <span className="highlight">Not Your Willpower</span>
            </h1>
            
            <p className="hero__subtitle animate-in delay-2">
              Traditional task apps assume discipline. This system <strong>enforces</strong> it.
              <br />
              Complete your tasks on Vikunja, or your Reddit/YouTube/Instagram stop working — automatically, on every device you own.
            </p>
              ...
              <div className="diagram__center">
                <div className="diagram__core">
                  <svg viewBox="0 0 100 100" fill="none">
                    <rect x="25" y="48" width="50" height="38" rx="6" fill="var(--accent-primary)"/>
                    <path d="M33 48 L33 36 Q33 18 50 18 Q67 18 67 36 L67 48" fill="none" stroke="var(--accent-primary)" strokeWidth="6" strokeLinecap="round"/>
                    <circle cx="50" cy="63" r="5" fill="var(--bg-deep)"/>
                    <rect x="47" y="63" width="6" height="10" rx="1" fill="var(--bg-deep)"/>
                  </svg>
                  <span>TaskLock</span>
                </div>
              </div>
              <div className="diagram__orbit">
                <div className="diagram__device" style={{ '--i': 0 } as CSSProperties}>
                  <span>📱</span>
                  <small>Phone</small>
                </div>
                <div className="diagram__device" style={{ '--i': 1 } as CSSProperties}>
                  <span>💻</span>
                  <small>Laptop</small>
                </div>
                <div className="diagram__device" style={{ '--i': 2 } as CSSProperties}>
                  <span>🎮</span>
                  <small>Console</small>
                </div>
                <div className="diagram__device" style={{ '--i': 3 } as CSSProperties}>
                  <span>📺</span>
          ...
          <AnimatedSection delay={0.1}>
            <div className="problem__story">
              <p className="problem__intro">
                I built this because I'm the kind of person who checks off tasks only when there are <strong>real consequences</strong>.
              </p>
              
              <div className="problem__list">
                <div className="problem__item">
                  <span className="problem__icon">🔔</span>
                  <span>Reminders? <strong>I swipe them away.</strong></span>
                </div>
                <div className="problem__item">
                  <span className="problem__icon">📲</span>
                  <span>Push notifications? <strong>Ignored within seconds.</strong></span>
                </div>
                <div className="problem__item">
                  <span className="problem__icon">📅</span>
                  <span>Daily routines? <strong>Gone by Tuesday.</strong></span>
                </div>
              </div>
              
              <p className="problem__turn">
                But when my social media, games, or distracting apps <strong>suddenly stop working</strong>, I get my stuff done.
              </p>
              
              <p>
                Not because I magically became disciplined — but because <strong>the environment finally supported the habits I wanted</strong>.
              </p>
        ...
        <div className="container">
          <AnimatedSection>
            <div className="what-is__header">
              <h2>A Self-Hosted, Privacy-First<br />Tough-Love System for the Home</h2>
          ...
          <AnimatedSection delay={0.2}>
            <p className="what-is__tagline">
              This is <strong>your network</strong>, enforcing <strong>your commitments</strong>, based on <strong>your rules</strong>.
            </p>
          </AnimatedSection>
        </div>
      </section>
            ...
            <div className="core-idea__card">
              <div className="core-idea__comparison">
                ...
                <div className="core-idea__side core-idea__side--consequence">
                  <div className="core-idea__icon">✗</div>
                  <p><strong>Skip the task</strong></p>
                  <span>→ your distractions get blocked across all your devices</span>
                </div>
              </div>
          ...
          <div className="steps">
            <AnimatedSection delay={0.1}>
              <div className="step">
                ...
                <div className="step__content">
                  ...
                  <p>
                    Your devices already use Pi-hole's DNS. Add any domains you want blocked (Reddit, Facebook, Instagram, YouTube, gaming servers, etc.). You control everything.
                  </p>
                  <div className="step__tags">
                    <span className="step__tag">Manual blocking: Free</span>
                    <span className="step__tag step__tag--pro">Automatic block packages: Pro</span>
                  </div>
                </div>
              </div>
            </AnimatedSection>
              ...
              <div className="step">
                ...
                <div className="step__content">
                  ...
                  <ul className="step__list">
                    ...
                    <li>All the static IPs belonging to you (phone, laptop, tablet, game console)</li>
                  </ul>
                  <p>
                    This creates <strong>per-person enforcement</strong>, not per-device. If you skip your tasks, every device assigned to you gets consequences — and no one else in your home is affected.
                  </p>
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2}>
              <div className="step">
                ...
                <div className="step__content">
                  <h3>(Optional Pro) Bark-Style Encrypted Push Notifications</h3>
                  <p>You can pair your Vikunja user with the Bark iOS app encryption model to receive:</p>
                  <ul className="step__list">
                  ...
                  <p>All done privately, with no cloud storage, using a proven encryption flow.</p>
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.25}>
              <div className="step">
                ...
                <div className="step__content">
                  ...
                  <p>
                    Daily tasks, weekly chores, monthly maintenance — you can automate all of it.
                  </p>
                  <div className="step__highlight">
                    <p>If something is <strong>overdue</strong>, your distraction domains flip off.</p>
                    <p>When you <strong>complete it</strong>, access returns instantly.</p>
                  </div>
                </div>
              </div>
            </AnimatedSection>
      ...
      <section className="comparison" id="features">
        <div className="container">
          <AnimatedSection>
            ...
            <p className="comparison__subtitle">Not a task app. Not a blocker. <strong>A behavior engine.</strong></p>
            <div className="divider" />
          </AnimatedSection>
              ...
              <table className="comparison__table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><span className="yes">✓</span></td>
                    <td className="comparison__highlight"><span className="yes">✓</span></td>
                  </tr>
                  <tr>
          ...
          <AnimatedSection delay={0.2}>
            <div className="comparison__category">
              ...
              <p className="comparison__category-name">Household Accountability Automation.</p>
            </div>
          </AnimatedSection>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <AnimatedSection delay={0.1}>
            <div className="audience__grid">
              ...
              <div className="audience__item">
                <span>🌟</span>
                <p>Anyone who benefits from gentle (or not-so-gentle) consequences</p>
              </div>
            </div>
          </AnimatedSection>
        </div>
          ...
          <AnimatedSection>
            <div className="privacy__card">
              ...
              <p className="privacy__main">
                This system <strong>never</strong> monitors content, activity, messages, browsing history, or behavior.
              </p>
              ...
              <p className="privacy__network">
                Nothing leaves your home network unless you choose optional encrypted push notifications.
              </p>
        ...
        <div className="container">
          <div className="footer__content">
            <p className="footer__tagline">
              ...
              <br />
              not by trying harder, but by designing an environment that helps them follow through.
            </p>
